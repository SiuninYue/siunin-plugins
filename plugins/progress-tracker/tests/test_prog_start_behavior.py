...
def sample_progress_data():
    ...
    return {
        ...
        "features": [
            ...
            {
                "id": 2,
                "name": "Feature Two Ready",
                "test_steps": ["run test"],
                "completed": False,
                "development_stage": "planning",
                "requirement_ids": ["REQ-002"],
                "change_spec": {
                    "why": "Implement feature two with proper readiness",
                    "in_scope": ["Feature two implementation"],
                    "out_of_scope": [],
                    "risks": [],
                },
                "acceptance_scenarios": ["Scenario: feature two starts successfully"],
            },
        ],
