...
- [ ] **Step 1: 找到 init_tracking() 的 return True（约 line 3724），在其前插入 notify**
...
- [ ] **Step 2: 找到 add_feature() 的 return True（约 line 6501），在其前插入 notify**
...
- [ ] **Step 3: 运行全量 test_parent_writeback.py 测试**
...
Expected: 556 passed（原 552 + 新 4），无 regression
