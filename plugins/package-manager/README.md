...
- v1.2.1 (2026-04-24): 修复规则验证脚本兼容性
- v1.2.0 (2026-04-08): 新增 update-all/update-global/update-project 命令
- v1.1.0 (2026-03-xx): 新增 codex-plugin-sync 技能
- v1.0.1 (2026-02-xx): 修复 lock 文件检测逻辑
- v1.0.0 (2026-02-xx): 首个正式版发布
